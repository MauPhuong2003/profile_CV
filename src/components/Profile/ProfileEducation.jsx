...
const ProfileEducation = ({ profileData, t }) => {
  return (
    <section id="education" className="scroll-mt-24 space-y-10">
      ...
      <div className="p-6 rounded-xl bg-app-card border border-app-border hover:border-app-accent/30 transition-all hover:scale-[1.005] relative overflow-hidden space-y-5 shadow-sm group">
        ...
        <div className="space-y-5 relative z-10">
          ...
          <div className="space-y-3">
            <p className="text-xs md:text-sm text-app-muted leading-relaxed tracking-wide">{profileData.education?.major}</p>
